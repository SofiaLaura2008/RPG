...
public class Pericias extends Ficha{
    ...
    public void habilidades() {
        System.out.println("Nome do personagem: " + getNome_personagem() + ", " + "Acrobacia: " + getAcrobacia() + ", " + "Atletismo: " + getAtletismo() + ", " + "Enganação: " + getEnganacao() + ", " + "Fortitude: " + getFortitude() + ", " + "Furtividade: " + getFurtividade() + ", " + "Intimidação: " + getIntimidacao() + ", " + "Intuição: " + getIntuicao() + ", " + "Investigação: " + getInvestigacao() + ", " + "Luta: " + getLuta() + ", " + "Medicina: " + getMedicina() + ", " + "Percepção: " + getPercepcao() + ", " + "Pilotagem: " + getPilotagem() + ", " + "Pontaria: " + getPontaria() + ", " + "Reflexos: " + getReflexos() + ", " + "Sobrevivência: " + getSobrevivencia() + ", " + "Tática: " + getTatica() + ", " + "Tecnologia: " + getTecnologia());
    }
}
